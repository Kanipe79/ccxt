...
from ..events import (
    EXEC_ORDER, RISK_VETO, ApprovedIntent, Control, FeedRecovered, PortfolioSnapshot,
    StaleFeed,
)
from ..risk import RiskEngine, RiskState
from ..types import Intent, RiskDecision, TargetSpec
...
class RiskService:
    ...
    def state(self) -> RiskState | None:
        ...
        return RiskState(
            ...
            stale_feeds=set(self.stale), orders_this_min=rate, now=now)
